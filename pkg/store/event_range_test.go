...
func TestQueryStateChangesWindowAndEventFilter(t *testing.T) {
	...
	changes := []EnrichedStateChange{
		{
			StateChange: event.StateChange{SubjectType: "Building", SubjectID: "1", Op: "set", Path: "level", After: event.ValueInt(1), Version: 1},
			EventID:     "e1", FlowID: "f1", Timestamp: base, EntityVersion: 1,
		},
		{
			StateChange: event.StateChange{SubjectType: "Building", SubjectID: "1", Op: "set", Path: "level", After: event.ValueInt(2), Version: 2},
			EventID:     "e2", FlowID: "f1", Timestamp: base.Add(200 * time.Millisecond), EntityVersion: 2,
		},
		{
			StateChange: event.StateChange{SubjectType: "Player", SubjectID: "7", Op: "set", Path: "gold", After: event.ValueInt(999), Version: 1},
